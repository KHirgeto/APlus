...
public class TinyDB {
    ...
    public ArrayList<Object> getListObject(String key, StudentClass mClass){
        Gson gson = new Gson();
    ...
    public < T > T getObject(String key, StudentClass classOfT){

        String json = getString(key);
        Object value = new Gson().fromJson(json, (Type) classOfT);
        if (value == null)
